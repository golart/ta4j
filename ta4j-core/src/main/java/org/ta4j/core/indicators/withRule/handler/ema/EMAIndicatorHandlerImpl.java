package org.ta4j.core.indicators.withRule.handler.ema;
...
public class EMAIndicatorHandlerImpl implements IIndicatorHandler {
    ...
    public TradeResultWrapper execute(final IndicatorRequestWrapper requestWrapper) {
        ...
        tradeLogger.info("Start execute EMA method \n");
        ...
        Rule entryRule = new CustomUnderOverIndicatorRule(ema, buyValue, symbolToBuy, Indicator.EMA.name());
        Rule exitRule = new CustomUnderOverIndicatorRule(ema, sellValue, symbolToSell, Indicator.EMA.name());

        tradeLogger.info("End execute EMA method \n");
